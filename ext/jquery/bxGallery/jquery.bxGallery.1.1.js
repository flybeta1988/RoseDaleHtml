				...
				bxGallery : function(options) {
					...
					function preload_img() {
						...
						if (o.load_text != '') {
							...
							$orig.before('<div id="loading"><img src="'
									+ o.load_image + '" /></div>');
						}
						...
						$orig
								...
								.each(
										function() {
											...
											var captionheight = 0;
											if ($this.parent().find('.caption')
													.height() > 0) {
												captionheight = $this.parent()
														.find('.caption')
														.height() + captionExtra;
											}
					...
					function place_thumbcontainer() {
						if (o.thumbplacement == 'top') {
							$outer.prepend('<ul class="thumbs">' + cont
									+ '</ul>');
							...
							$outer.append('<ul class="thumbs">' + cont
									+ '</ul>');
